...
# 💻 Tech Stack:
![My Skills](https://skillicons.dev/icons?i=js,html,css,react,nodejs,nextjs,mongodb,cypress,elasticsearch,express,python,flask,gcp,git,gitlab,heroku,jest,materialui,npm,redux,sass,sentry,vite,webpack)
